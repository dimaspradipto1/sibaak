                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20" style="background: linear-gradient(45deg, #087C39, #FFF742); border:none">Sign in</button>
                                    </div>
                                </div>
                                <hr />
                                <p>Don't have an account? <a href="{{ route('register') }}" class="text-success">Register</a></p>
                            </div>
                        </div>
                    </form>
                    <!-- end of form -->
