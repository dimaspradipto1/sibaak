    ...
    <div class="card-header bg-white border-bottom py-2 px-3">
        <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <h5 class="m-0 font-weight-bold text-dark" style="font-size: 1rem;">Data SK Kepanitiaan</h5>
            </div>
            @can('sk_kepanitiaan_create')
            <div class="d-inline-flex shadow-sm overflow-hidden" style="border: 1px solid #e3e6f0; border-radius: 30px;">
                <a href="{{ route('skkepanitiaan.create') }}" class="btn btn-success rounded btn-xs font-weight-bold px-3 py-1 border-0" style="background-color: #046B26; color: white; font-size: 10px; height: 32px; line-height: 24px;">
