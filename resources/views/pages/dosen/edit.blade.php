                    ...
                    <form action="{{ route('dosen.update', $dosen->id) }}" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="nup" value="{{ old('nup', $dosen->nup) }}"
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="nuptk" value="{{ old('nuptk', $dosen->nuptk) }}"
                            ...
                            <div class="col-sm-10">
                                <select name="program_studi_id" class="form-control rounded @error('program_studi_id') is-invalid @enderror">
                                    ...
                                    @foreach ($program_studis as $program_studi)
                                        <option value="{{ $program_studi->id }}" {{ old('program_studi_id', $dosen->program_studi_id) == $program_studi->id ? 'selected' : '' }}>{{ $program_studi->program_studi }}</option>
                                    @endforeach
                                </select>
