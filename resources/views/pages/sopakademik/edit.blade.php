                            ...
                            <div class="col-sm-10">
                                <select name="fakultas" id="fakultas" class="form-control rounded">
                                    ...
                                    <option value="Fakultas Ekonomi dan Bisnis"
                                        {{ old('fakultas', $sopakademik->fakultas) == 'Fakultas Ekonomi dan Bisnis' ? 'selected' : '' }}>Fakultas
                                        Ekonomi dan Bisnis</option>
                                    <option value="Fakultas Sains dan Teknologi"
                                        {{ old('fakultas', $sopakademik->fakultas) == 'Fakultas Sains dan Teknologi' ? 'selected' : '' }}>Fakultas
                                        Sains dan Teknologi</option>
                                    <option value="Fakultas Ilmu Kesehatan"
                                        {{ old('fakultas', $sopakademik->fakultas) == 'Fakultas Ilmu Kesehatan' ? 'selected' : '' }}>Fakultas Ilmu
                                        Kesehatan</option>
                                </select>
                                @error('fakultas')
