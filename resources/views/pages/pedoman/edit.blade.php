                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="fakultas" class="form-control rounded">
                                    ...
                                    <option value="">=====================</option>
                                    <option value="Fakultas Ekonomi dan Bisnis" {{ old('fakultas', $pedoman->fakultas) == 'Fakultas Ekonomi dan Bisnis' ? 'selected' : '' }}>Fakultas Ekonomi dan Bisnis (FEB)</option>
                                    <option value="Fakultas Sains dan Teknologi" {{ old('fakultas', $pedoman->fakultas) == 'Fakultas Sains dan Teknologi' ? 'selected' : '' }}>Fakultas Sains dan Teknologi (FST)</option>
                                    <option value="Fakultas Ilmu Kesehatan" {{ old('fakultas', $pedoman->fakultas) == 'Fakultas Ilmu Kesehatan' ? 'selected' : '' }}>Fakultas Ilmu Kesehatan (Fikes)</option>
                                    <option value="BAAK" {{ old('fakultas', $pedoman->fakultas) == 'BAAK' ? 'selected' : '' }}>BAAK (Biro Administrasi Akademik dan Kemahasiswaan)</option>
                                </select>
                                @error('fakultas')
