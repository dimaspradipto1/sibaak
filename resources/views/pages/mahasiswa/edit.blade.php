                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="jenjang_pendidikan" id="jenjang_pendidikan" class="form-control rounded">
                                    <option value="">{{ old('jenjang_pendidikan', $mahasiswa->jenjang_pendidikan) }}
                                    </option>
                                    <option disabled>=================================</option>
                                    <option value="S-1"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="semester" id="semester" class="form-control rounded">
                                    ...
                                    <option disabled>=========================================</option>
                                    <option value="I (Satu)"
                                        {{ old('semester', $mahasiswa->semester) == 'I (Satu)' ? 'selected' : '' }}>I
                                        (Satu)</option>
                                    <option value="II (Dua)"
                                        {{ old('semester', $mahasiswa->semester) == 'II (Dua)' ? 'selected' : '' }}>II
                                        (Dua)</option>
                                    <option value="III (Tiga)"
                                        {{ old('semester', $mahasiswa->semester) == 'III (Tiga)' ? 'selected' : '' }}>III
                                        (Tiga)</option>
                                    <option value="IV (Empat)"
                                        {{ old('semester', $mahasiswa->semester) == 'IV (Empat)' ? 'selected' : '' }}>IV
                                        (Empat)</option>
                                    <option value="V (Lima)"
                                        {{ old('semester', $mahasiswa->semester) == 'V (Lima)' ? 'selected' : '' }}>V
                                        (Lima)</option>
                                    <option value="VI (Enam)"
                                        {{ old('semester', $mahasiswa->semester) == 'VI (Enam)' ? 'selected' : '' }}>VI
                                        (Enam)</option>
                                    <option value="VII (Tujuh)"
                                        {{ old('semester', $mahasiswa->semester) == 'VII (Tujuh)' ? 'selected' : '' }}>VII
                                        (Tujuh)</option>
                                    <option value="VIII (Delapan)"
                                        {{ old('semester', $mahasiswa->semester) == 'VIII (Delapan)' ? 'selected' : '' }}>
                                        VIII (Delapan)</option>
                                    <option value="IX (Sembilan)"
                                        {{ old('semester', $mahasiswa->semester) == 'IX (Sembilan)' ? 'selected' : '' }}>IX
                                        (Sembilan)</option>
                                    <option value="X (Sepuluh)"
                                        {{ old('semester', $mahasiswa->semester) == 'X (Sepuluh)' ? 'selected' : '' }}>X
                                        (Sepuluh)</option>
                                    <option value="XI (Sebelas)"
                                        {{ old('semester', $mahasiswa->semester) == 'XI (Sebelas)' ? 'selected' : '' }}>XI
                                        (Sebelas)</option>
                                    <option value="XII (Dua Belas)"
                                        {{ old('semester', $mahasiswa->semester) == 'XII (Dua Belas)' ? 'selected' : '' }}>
