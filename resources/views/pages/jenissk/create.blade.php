        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form action="{{ route('jenissk.store') }}" method="POST">
                        @csrf
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Nama Jenis SK</label>
                            <div class="col-sm-10">
                                <input type="text" name="jenis_sk" value="{{ old('jenis_sk') }}" class="form-control rounded"
                                    placeholder="Masukkan nama jenis sk">
                                    @error('jenis_sk')
