        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5>Form Kategori Arsip</h5>
                 </div>
                <div class="card-block">
                    <h4 class="sub-title">Form Inputs</h4>
                    <form action="{{ route('kategoriarsip.store') }}" method="POST">
                        @csrf
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Nama Kategori Arsip</label>
                            <div class="col-sm-10">
                                <input type="text" name="kategori_arsip" value="{{ old('kategori_arsip') }}" class="form-control rounded"
