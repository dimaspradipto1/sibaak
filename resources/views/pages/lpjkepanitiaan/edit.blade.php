        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form action="{{ route('lpjkepanitiaan.update', $lpjkepanitiaan->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-sm-10">
                               <select name="tahun_akademik_id" class="form-control rounded">
                                   ...
                                   @foreach ($tahunAkademik as $item)
                                       <option value="{{ $item->id }}" {{ old('tahun_akademik_id', $lpjkepanitiaan->tahun_akademik_id) == $item->id ? 'selected' : '' }}>{{ $item->tahun_akademik }}</option>
                                   @endforeach
                               </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="semester" id="" class="form-control rounded">
                                    ...
                                    <option value="">=====================</option>
                                    <option value="Gasal" {{ old('semester', $lpjkepanitiaan->semester) == 'Gasal' ? 'selected' : '' }}>Gasal</option>
                                    <option value="Genap" {{ old('semester', $lpjkepanitiaan->semester) == 'Genap' ? 'selected' : '' }}>Genap</option>
                                </select>
                                @error('semester')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="nama_dokumen" class="form-control rounded" id="" cols="30" rows="3">{{ old('nama_dokumen', $lpjkepanitiaan->nama_dokumen) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="ketua" value="{{ old('ketua', $lpjkepanitiaan->ketua) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="sekretaris" value="{{ old('sekretaris', $lpjkepanitiaan->sekretaris) }}"
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                               <select name="fakultas" class="form-control rounded">
                                   ...
                                   <option value="Fakultas Ekonomi dan Bisnis" {{ old('fakultas', $lpjkepanitiaan->fakultas) == 'Fakultas Ekonomi dan Bisnis' ? 'selected' : '' }}>Fakultas Ekonomi dan Bisnis</option>
                                   <option value="Fakultas Sains dan Teknologi" {{ old('fakultas', $lpjkepanitiaan->fakultas) == 'Fakultas Sains dan Teknologi' ? 'selected' : '' }}>Fakultas Sains dan Teknologi</option>
                                   <option value="Fakultas Ilmu Kesehatan" {{ old('fakultas', $lpjkepanitiaan->fakultas) == 'Fakultas Ilmu Kesehatan' ? 'selected' : '' }}>Fakultas Ilmu Kesehatan</option>
                               </select>
                            </div>
                        </div>
