        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5>Form Edit Wasdalbin</h5>
                </div>
                <div class="card-block">
                    <h4 class="sub-title">Form Inputs</h4>
                    <form action="{{ route('wasdalbin.update', $wasdalbin->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="tahun" value="{{ old('tahun') ?? $wasdalbin->tahun }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="nama_wasdalbin" class="form-control rounded" id="" cols="30" rows="3">{{ old('nama_wasdalbin') ?? $wasdalbin->nama_wasdalbin }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="fakultas" class="form-control rounded">
                                    ...
                                    <option value="">=====================</option>
                                    <option value="Fakultas Ekonomi dan Bisnis" {{ old('fakultas', $wasdalbin->fakultas) == 'Fakultas Ekonomi dan Bisnis' ? 'selected' : '' }}>Fakultas Ekonomi dan Bisnis (FEB)</option>
                                    <option value="Fakultas Sains dan Teknologi" {{ old('fakultas', $wasdalbin->fakultas) == 'Fakultas Sains dan Teknologi' ? 'selected' : '' }}>Fakultas Sains dan Teknologi (FST)</option>
                                    <option value="Fakultas Ilmu Kesehatan" {{ old('fakultas', $wasdalbin->fakultas) == 'Fakultas Ilmu Kesehatan' ? 'selected' : '' }}>Fakultas Ilmu Kesehatan (Fikes)</option>
                                    <option value="BAAK" {{ old('fakultas', $wasdalbin->fakultas) == 'BAAK' ? 'selected' : '' }}>BAAK (Biro Administrasi Akademik dan Kemahasiswaan)</option>
                                </select>
                                @error('fakultas')
