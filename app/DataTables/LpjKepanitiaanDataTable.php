        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($item) {
                ...
                if (Gate::check('lpj_kepanitiaan_view')) {
                    $btn .= '
                        <a href="' . route('lpjkepanitiaan.show', $item->id) . '" class="btn btn-dark btn-sm px-3 rounded mx-1" title="Detail">
                            <i class="fa-solid fa-eye"></i>
                        </a>
                    ';
                }
                if (Gate::check('lpj_kepanitiaan_edit')) {
                    $btn .= '
                        <a href="' . route('lpjkepanitiaan.edit', $item->id) . '" class="btn btn-warning btn-sm px-3 rounded mx-1" title="Edit">
                            <i class="fa-solid fa-pen-to-square"></i>
                        </a>
                    ';
                }
                if (Gate::check('lpj_kepanitiaan_delete')) {
                    $btn .= '
