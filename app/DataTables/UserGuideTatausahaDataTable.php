    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('liat_dokumen', function ($item) {
                return '<a href="' . $item->link_dokumen . '" target="_blank" style="background-color: #2FA12C; color: #ffffff;" class="btn btn-sm px-3 rounded" title="Lihat Dokumen"><i class="fa-solid fa-eye"></i> Detail</a>';
            })
